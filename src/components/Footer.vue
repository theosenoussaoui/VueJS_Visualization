<template>
  <div class="footer uk-light">
    ...
    <button class="uk-button uk-button-default uk-margin-small-right uk-margin-small-left" type="button" uk-toggle="target: #modal-container">Bouton modale choix pays</button>
